...
class RedisClusterCRC16 {
     ...
     */
    static int getCRC16(const(ubyte)[] bytes, size_t s, size_t e) {
        int crc = 0x0000;
    ...
    static int getCRC16(const(ubyte)[] bytes) {
        return getCRC16(bytes, 0, bytes.length);
    }

    static int getCRC16(string key) {
        const(ubyte)[] bytesKey = SafeEncoder.encode(key);
