...
mixin template RedisClusterCommandTemplate1(string name, R, string[] args) {
    import std.format;
...
//         mixin RedisClusterCommandTemplate1!("set", string, [key.stringof, value.stringof]);
//     }
...
//         mixin RedisClusterCommandTemplate1!("set", string, [key.stringof, value.stringof, params.stringof]);
//     }
...
//         mixin RedisClusterCommandTemplate1!("get", const(ubyte)[], [key.stringof]);
//     }
...
//         mixin RedisClusterCommandTemplate1!("exists", Long, [keys.stringof]);
//     }
...
//         mixin RedisClusterCommandTemplate1!("exists", Boolean, [key.stringof]);
//     }
...
//         // }
//         // }.runBinary(key);
//         mixin RedisClusterCommandTemplate1!("persist", Long, [key.stringof]);
//     }
...
//         mixin RedisClusterCommandTemplate1!("type", string, [key.stringof]);
//     }
...
//         mixin RedisClusterCommandTemplate1!("dump", const(ubyte)[], [key.stringof]);
//     }
...
//         }
//         }.runBinary(keys.length, keys);
//         mixin RedisClusterCommandTemplate1!("dump", const(ubyte)[], [keys.stringof]);
//     }
